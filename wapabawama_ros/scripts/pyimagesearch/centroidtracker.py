...
class CentroidTracker():
    def __init__(self, maxDisappeared=50):
        ...
        self.subb = rospy.Subscriber(
            bbox_topic, BoundingBoxes, self.boxcallback)
        self.pubb = rospy.Publisher(

            tracked_bbox_topic, BoundingBoxes, queue_size=50)
        self.rate = rospy.Rate(10)
        self.nextObjectID = 0
        self.objects = OrderedDict()
        self.disappeared = OrderedDict()
        self.rects = []
        img_topic = "/right_camera/darknet_ros/detection_image"
    ...
    def boxcallback(self, msg):
        ...
        for i in range(len(msg.bounding_boxes)):
            ...
            self.rects.append(
                np.array([bbox.xmin, bbox.ymin, bbox.xmax, bbox.ymax]))
